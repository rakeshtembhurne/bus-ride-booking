  ...
  id: "actions", // Unique identifier for the action column
      ...
      cell: ({ row }) => (
        <div className="flex space-x-2">
          <Button
            variant="link"
            onClick={() => alert(`View ${row.getValue("routeId")}`)} // Corrected field
          >
            <FontAwesomeIcon icon={faEye} />
          </Button>
          <Button
            variant="link"
            onClick={() => alert(`Edit ${row.getValue("routeId")}`)} // Corrected field
          >
            <FontAwesomeIcon icon={faEdit} />
          </Button>
          <Button
            variant="link"
            onClick={() => alert(`Delete ${row.getValue("routeId")}`)} // Corrected field
          >
