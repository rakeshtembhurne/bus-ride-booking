  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex space-x-2">
        ...
        <Button
          variant="link"
          onClick={() => alert(`View ${row.getValue("routeId")}`)} // Replace with your view action
        >
        ...
        <Button
          variant="link"
          onClick={() => alert(`Edit ${row.getValue("routeId")}`)} // Replace with your edit action
        >
        ...
        <Button
          variant="link"
          onClick={() => alert(`Delete ${row.getValue("routeId")}`)} // Replace with your delete action
        >
