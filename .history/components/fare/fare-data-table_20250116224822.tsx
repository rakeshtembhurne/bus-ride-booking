...
export const columns: ColumnDef<Fare>[] = [
  {
    accessorKey: "route",
    header: "Route", // Instead of a function, directly provide JSX or text
    cell: ({ row }) => <div>{row.getValue("route")}</div>,
  },
  {
    accessorKey: "fromLocation",
    header: "From Location", // Direct JSX or text
    cell: ({ row }) => <div>{row.getValue("fromLocation")}</div>,
  },
  {
    accessorKey: "toLocation",
    header: "To Location", // Direct JSX or text
    cell: ({ row }) => <div>{row.getValue("toLocation")}</div>,
  },
  {
    accessorKey: "price",
    header: "Price", // Direct JSX or text
    cell: ({ row }) => <div>{row.getValue("price")}</div>,
  },
  {
    id: "actions",
    header: "Actions", // Direct JSX or text
    cell: ({ row }) => {
