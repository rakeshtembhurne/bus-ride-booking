...
export default function FareForm() {
  ...
  useEffect(() => {
    ...
    const fromLocation = searchParams.get("fromLocation") || ""; // Fallback to empty string if null
    const toLocation = searchParams.get("toLocation") || ""; // Fallback to empty string if null
    const price = searchParams.get("price") ? Number(searchParams.get("price")) : 0; // Fallback to 0 if null
