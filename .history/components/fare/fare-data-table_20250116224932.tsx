...
export const columns: ColumnDef<Fare>[] = [
  {
    accessorKey: "route",
    header: "Route", // Direct text (or JSX)
    cell: ({ row }) => <div>{row.getValue("route")}</div>,
  },
  {
    accessorKey: "fromLocation",
    header: "From Location", // Direct text (or JSX)
    cell: ({ row }) => <div>{row.getValue("fromLocation")}</div>,
  },
  {
    accessorKey: "toLocation",
    header: "To Location", // Direct text (or JSX)
    cell: ({ row }) => <div>{row.getValue("toLocation")}</div>,
  },
  {
    accessorKey: "price",
    header: "Price", // Direct text (or JSX)
    cell: ({ row }) => <div>{row.getValue("price")}</div>,
  },
  {
    id: "actions",
    header: "Actions", // Direct text (or JSX)
    cell: ({ row }) => {
