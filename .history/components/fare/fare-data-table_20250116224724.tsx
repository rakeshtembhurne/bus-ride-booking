...
export const columns: ColumnDef<Fare>[] = [
  {
    accessorKey: "route",
    header: () => <span>Route</span>, // Return JSX element directly
    cell: ({ row }) => <div>{row.getValue("route")}</div>,
  },
  {
    accessorKey: "fromLocation",
    header: () => <span>From Location</span>, // Return JSX element directly
    cell: ({ row }) => <div>{row.getValue("fromLocation")}</div>,
  },
  {
    accessorKey: "toLocation",
    header: () => <span>To Location</span>, // Return JSX element directly
    cell: ({ row }) => <div>{row.getValue("toLocation")}</div>,
  },
  {
    accessorKey: "price",
    header: () => <span>Price</span>, // Return JSX element directly
    cell: ({ row }) => <div>{row.getValue("price")}</div>,
  },
  {
    id: "actions",
    header: () => <span>Actions</span>, // Return JSX element directly
    cell: ({ row }) => {
