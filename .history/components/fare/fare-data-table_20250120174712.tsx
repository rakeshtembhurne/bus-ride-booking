            ...
            {data.length ? (
              data.map((fare) => (
                <TableRow key={fare.id}>
                  <TableCell>
                  {fare.fromLocation && fare.toLocation && routes.find(route => route.id === fare.routeId)?.departureTime
  ? `${fare.fromLocation} to ${fare.toLocation} - Departs at ${routes.find(route => route.id === fare.routeId)?.departureTime}`
  : "N/A"}               </TableCell>                  
