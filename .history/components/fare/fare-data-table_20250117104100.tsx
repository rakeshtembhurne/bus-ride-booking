                  ...
                  <TableRow key={row.id}>
                    {row.getVisibleCells().map((cell) => (
                      <TableCell key={cell.id}>
                        {cell.column.id === "toLocationId" ? (
                          // Map the `toLocationId` to the location name from the locations state
                          locations.find((location) => location.id === row.getValue("toLocationId"))?.name || "Unknown"
                        ) : (
