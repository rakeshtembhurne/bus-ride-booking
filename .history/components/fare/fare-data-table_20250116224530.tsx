...
export const columns: ColumnDef<Fare>[] = [
  export const columns: ColumnDef<Fare>[] = [
    {
      accessorKey: "route",
      header: <span>Route</span>,  // Direct ReactNode, no function needed
      cell: ({ row }) => <div>{row.getValue("route")}</div>,
    },
    {
      accessorKey: "fromLocation",
      header: <span>From Location</span>,  // Direct ReactNode
      cell: ({ row }) => <div>{row.getValue("fromLocation")}</div>,
    },
    {
      accessorKey: "toLocation",
      header: <span>To Location</span>,  // Direct ReactNode
      cell: ({ row }) => <div>{row.getValue("toLocation")}</div>,
    },
    {
      accessorKey: "price",
      header: <span>Price</span>,  // Direct ReactNode
      cell: ({ row }) => <div>{row.getValue("price")}</div>,
    },
    {
      id: "actions",
      header: <span>Actions</span>,  // Direct ReactNode
      cell: ({ row }) => {
