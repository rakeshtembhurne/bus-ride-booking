  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex justify-end space-x-2">
        ...
        <Button
          variant="link"
          onClick={() => handleDelete(row.getValue("name"), row.id)} // Use handleDelete here
        >
...
export function DataTableDemo() {
  ...
  const handleDelete = (name: string, id: string) => {
    ...
    if (confirmation) {
      // Perform the delete action here (e.g., call API or navigate)
      router.push(`/location/${id}/delete`); // Navigate to the delete route
    }
  };
