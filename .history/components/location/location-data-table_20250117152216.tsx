...
export function DataTableDemo() {
  ...
  const handleDelete = (row) => {
    console.log(row); // Add this line to inspect the row structure
    const confirmation = window.confirm(`Are you sure you want to delete ${row.original?.name}?`);
    if (confirmation) {
      router.push(`/locations/${row.original?.id}/delete`);
    }
  };
