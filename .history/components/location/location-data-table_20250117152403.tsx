...
export function DataTableDemo() {
  ...
  const handleDelete = (row) => {
    console.log(row);  // Log the entire row to verify if 'id' is available
    ...
    const confirmation = window.confirm(`Are you sure you want to delete ${locationName}?`);
    if (confirmation) {
      router.push(`/locations/${locationId}/delete`);
    }
  };
