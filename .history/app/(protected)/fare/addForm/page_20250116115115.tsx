...
import { fareSchema } from "@/lib/validations/fare"; // Adjust the path based on where fareSchema is located
...
export default function AddFarePage() {
  ...
  const onSubmit = async (data: FareFormValues) => {
    try {
      ...
      console.log("Sending POST request to:", '/api/fare/route'); // Log URL for inspection
