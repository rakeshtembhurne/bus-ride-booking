...
export default function AddFarePage() {
  ...
  const onSubmit = async (formData: any) => {
    try {
      // Assuming you're using some method to get the logged-in user's ID
      const loggedInUserId = "user-id" // Replace this with actual user ID from session or context
      ...
      const data = {
        ...
        createdByUserId: loggedInUserId, // Dynamically get user ID
      }
